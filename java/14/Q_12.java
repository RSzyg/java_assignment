...
public class Q_12 extends Application {
    ...
    private static String[] titles = new String[] {
            "项目 - " + String.format("%d%s", (int)(100 * percent[0]), "%"),
            "测试 - " + String.format("%d%s", (int)(100 * percent[1]), "%"),
            "期中考试 - " + String.format("%d%s", (int)(100 * percent[2]), "%"),
            "期末考试 - "+ String.format("%d%s", (int)(100 * percent[3]), "%")
     };
